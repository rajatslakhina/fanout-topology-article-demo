...
final class CoordinationModelTests: XCTestCase {
    ...
    /// The token premium never appears in the break-even. Doubling it moves nothing.
    func testTokenPremiumDoesNotMoveTheBreakEven() {
        let cheap = CoordinationModel(tokenPremium: 1.1, parallelGainCeiling: 0.81, sequentialPenalty: 0.39)
